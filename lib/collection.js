...
Collection.prototype.find = function(query, options, callback) {
  ...
  let project = options.project || options.fields;

  if (project && !Buffer.isBuffer(project) && Array.isArray(project)) {
    const objectProject = {};
  ...
  if (project) findCommand.fields = project;
